...
const ProfileInfo = () => {
  const userProfile = {
    avatar_url: "https://octodex.github.com/images/femalecodertocat.png",
    bio: "👨🏻‍💻👨🏻‍💻👨🏻‍💻",
    email: "vineelavel@gmail.com",
    followers: 100,
    following: 200,
    html_url: "https://github.com/VelpuriVineela",
    location: "Somewhere, Earth",
    name: "vineela velpuri",
    public_gists: 100,
    public_repos: 100,
    twitter_username: "vineelavel",
    login: "vineelavel",
  };
  ...
  return (
    <div className="lg:w-1/3 w-full flex flex-col gap-2 md:sticky md:top-10">
      <div className="bg-glass rounded-lg p-4">
        ...
        {/* User Bio */}
        {/* if the user has bio it will show ortherwise it shoes nothing */}
        {userProfile?.bio ? (
